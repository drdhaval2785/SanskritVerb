...
/* Nicazca (1.3.74) */
elseif ( $verbset==='curAdi' || $sanAdi==="Ric")
{
    $suffix=$tiG;
...
elseif ( ends(array($fo),array("vftu!","vfDu!","SfDu!","syandU!",),4) && in_array($lakAra,array("lfw","lfN")) && in_array($so,$taG))
{
	...
	echo "<p class = st >न वृद्भ्यश्चतुर्भ्यः (७.२.५९) :</p>\n";
	echo "<p class = hn >इडागमः क्रियते ।</p>\n";
	echo "<hr>\n";
}
...
if ( ends(array($fo),array("iN"),4) && in_array($lakAra,array("luN","lfN")) && $Nit===0 && $Jit===0)
{
	$text = two(array("iN"),array("+"),array("gAN"),array("+"),1);
	echo "<p class = pa >By vibhASA luGlRGoH (".link_sutra("2.4.50").") :</p>\n"; 
	echo "<p class = pa >विभाषा लुङ्लृङोः (२.४.५०) :</p>\n";
	display(0);
}
...
if (in_array($lakAra,$ArdhadhAtuka_lakAra))
{
    ...
    /* gAGkuTAdibhyo'JNinGit (1.2.1) */ 
    if ( ends(array($fo),$tudAdi_kuTAdi,4) && ($verbset==="tudAdi" || $verbset==="none" ) && in_array($lakAra,$ArdhadhAtuka_lakAra) && $Nit===0 && $Jit===0)
    {
        $itpratyaya=array_merge($itpratyaya,array("N"));
        $it=array_merge($it,array("N"));
        echo "<p class = pa >By gAGkuTAdibhyo'JNinGit (".link_sutra("1.2.1").") :</p>\n"; 
    ...
    /* vija iT (1.2.2) */ 
    if ( ends(array($fo),array("o!vijI!"),4) && sub(array("o!vijI!"),array("+"),$ArdhadhAtuka_tiG_pratyayas,0) && in_array($lakAra,$ArdhadhAtuka_lakAra) && $id_dhAtu==="sew" && $id_pratyaya==="sew" && $verbset==="tudAdi")
    {
        $itpratyaya=array_merge($itpratyaya,array("N"));
        $it=array_merge($it,array("N"));
...
if ( in_array($sanAdi,array("Aya","IyaN","RiN")) && sub(array("Aya","IyaN","RiN"),array("+"),$ArdhadhAtuka_tiG_pratyayas,0) && $lakAra!=="")
{
    $text=three(array("+"),array("Aya+","IyaN+","RiN+"),$ArdhadhAtuka_tiG_pratyayas,array("+"),array("","",""),$ArdhadhAtuka_tiG_pratyayas,1);
...
if (sub($curAdi,array("+"),$tiG,0) && ends(array($fo),$curAdi,4) && ($sarvadhatuka===1 || $ardhadhatuka===1) && $verbset==="curAdi")
{
...
/* satyApapAzarUpavINAtUlazlokasenAlomatvacavarmacUrNacurAdibhyo Nic (3.1.25) */
elseif (sub($curAdi,array("+"),$tiG,0) && ends(array($fo),$curAdi,4) && ($sarvadhatuka===1 || $ardhadhatuka===1) && $verbset==="none")
{
    $text=two(array("+"),$tiG,array("+Ric+"),$tiG,0);
    $text=one(array("+Ric+Ric"),array("+Ric+"),0);
    echo "<p class = sa >By satyApapAzarUpavINAtUlazlokasenAlomatvacavarmacUrNacurAdibhyo Nic (".link_sutra("3.1.25").") :</p>\n"; 
...
if (in_array($so,$tiG) && ( sub(array("+"),$inbetweenpratyaya,array("+"),0) || (arr($text,'/['.flat($hl).']$/') && $tusma!==1) || sub($hl,array("+"),$vikaraNa,0) || $ad===1 || $rudhAdibhyaH===1 || in_array($lakAra,array("liw","luw","lfw","ASIrliN","luN","lfN","ArDaDAtukalew")) ))
{
    ...
    {
        $text=three($hl,array("+"),$tiG,blank(count($hl)),array("+"),$tiG,0);
    }
    if ($tusma!==1)
    {
        itprat('/(['.flat($hl).']$)/');
...
if ( in_array($lakAra,array("viDiliN","ASIrliN")) && sub(array("+"),array("t","T","At","AT"),blank(0),0)  )
{
    ...
    if (pr2(array("+s"),$taG,blank(0),array("+"),$taG,blank(0),$text)!== $text && in_array($lakAra,array("viDiliN")))
    {
...
{
    pr2(array("+"),array("ti","anti","si","mi"),blank(0),array("+"),array("t","ant","s","m"),blank(0),$text);
...
/* aniditAM hala upadhAyAH kGiti (6.4.24) */ 
if ( sub($aniditverbs,array("+"),blank(0),0) && (in_array("N",$itpratyaya) || in_array("k",$itpratyaya)) )
{
...
if ( pr2(array("mfj"),array("+"),$ArdhadhAtuka_tiG_pratyayas,array("mArj"),array("+"),$ArdhadhAtuka_tiG_pratyayas,$text)!==$text && in_array($so,$tiG))
{
    $text=pr2(array("mfj"),array("+"),$ArdhadhAtuka_tiG_pratyayas,array("mArj"),array("+"),$ArdhadhAtuka_tiG_pratyayas,$text);
...
if ( sub(array("v","y"),array("+"),prat("vl"),0) && !in_array($sanAdi,array("Ric")))
{
...
if (ends(array($fo),array("jyA","graha!","vaya!","vyaDa!","vaSa!","vyaca!","o!vraScU!","praCa!","Brasja!"),4) && (sub(array("jyA","grah","vay","vyaD","vaS","vyac","vraSc","pracC","Brasj"),array("+"),$apit_sArvadhAtuka_pratyayas,0) || in_array("N",$itpratyaya) || in_array("k",$itpratyaya)))
{
...
if (sub(array("lI"),array("+"),blank(0),0) && ((ends(array($fo),array("lI"),4) && $verbset==="kryAdi") || (ends(array($fo),array("lIN"),4) && $verbset==="none") ))
{
    $text=three(array("lI"),array("+"),blank(0),array("lA"),array("+"),blank(0),1);    
...
/* yasya halaH (6.4.49) */
if ( sub($hl,array("ya+"),$ArdhadhAtuka_pratyayas,0) )
{ 
...
if ( sub(array("han"),array("+"),blank(0),0) && arr(array($fo),'/[h][a][n]/') && !in_array($fo,array("ahan","dIrGAhan")) && (in_array("R",$it) || in_array("Y",$it) || in_array($sanAdi,array("Ric"))) )
{
...
// more on enumeration kind. Not used regexes deliberately.
if ( sub(array("a"),$hl,array("+Ri+"),0) && $atolopa!==1 && $Naugami!==1 && $jAgro!==1)
{
...
if ( (in_array("N",$it)||in_array("k",$it) ) && sub(array("A+"),$ajAdi_kitGit_ArdhadhAtuka_pratyayas,blank(0),0) && $lakAra!=="" )
{
...
if ( ends(array($fo),array("do","deN","qudAY","dAR","Dew","quDAY","mA","sTA","iN","pA","hA","sA",),4) && ends($it,array("N","k"),2) && sub(array("A+"),$halAdi_kitGit_ArdhadhAtuka_pratyayas,blank(0),0) && $lakAra!=="" )
{
...
if ( sub(array("f"),$hlplus,prat('Jl'),0) && ends(array($fo),array("sfpx!","spfSa!","mfSa!","kfza!","tfpa!","dfpa!"),4) && !in_array("k",$itpratyaya) )
{
...
if ( sub(array("Brasj"),array("+"),prat('Jl'),0) && ends(array($fo),array("Brasja!"),4) && $ardhadhatuka===1 )
{ 
...
elseif(sub(array("gup+Aya"),array("+"),blank(0),0) )
{
	$text = one(array("gup+Aya","gup+"),array("gopAya","gop+"),0); // for accomodating Aya pratyaya
    echo "<p class = sa >pugantalaghUpadhasya ca (".link_sutra("7.3.86").") :</p>\n"; 
    echo "<p class = sa >पुगन्तलघूपधस्य च (७.३.८६) 6:</p>\n";
    display(0);
}
elseif(sub(array("fp","hrIp","vlIp","rIp","knUp","kzmAp","blIp"),array("+"),array("i+"),0) ) // for puganta
{
...
elseif ( sub(array("i","u","f","x"),$hl,array("+u+","+i+"),0) && $atolopa!==1 && ($sarvadhatuka===1 || $ardhadhatuka===1) && arr($text,'/[iufx]['.pc('hl').'][+]/')  && $didhI!==1)
{
...
/* pugantalaghUpadhasya ca (7.3.86) */
elseif ( pr2(array("i","u","f","x"),$hlplus,$ArdhadhAtuka_tiG_pratyayas,array("e","o","ar","al"),$hlplus,$ArdhadhAtuka_tiG_pratyayas,$text)!==$text && $atolopa!==1 && $ardhadhatuka===1 && $kGiti!==1  && $didhI!==1)
{
...
/* pugantalaghUpadhasya ca (7.3.86) */
elseif ( $atolopa!==1 && ($sarvadhatuka===1 || $ardhadhatuka===1) && arr($text,'/[iufx]['.pc('hl').'][+]/') && pr2(array("i","u","f","x"),$hlplus,$pit_sArvadhAtuka_pratyayas,array("e","o","ar","al"),$hlplus,$pit_sArvadhAtuka_pratyayas,$text)!==$text && !arr($text,"/[+][i][y][+][t]$/")  && $didhI!==1)
{
...
/* pugantalaghUpadhasya ca (7.3.86) */
elseif ( $atolopa!==1 && $ardhadhatuka===1 && arr($text,'/[iufx]['.pc('hl').'][+]/') && pr2(array("i","u","f","x"),$hlplus,$ArdhadhAtuka_pratyayas,array("e","o","ar","al"),$hlplus,$ArdhadhAtuka_pratyayas,$text)!==$text && !arr($text,"/[+][i][y][+][t]$/")  && $didhI!==1)
{
...
elseif ( $atolopa!==1 && ($sarvadhatuka===1 || $ardhadhatuka===1) && arr($text,'/[iufx]['.pc('hl').'][+]$/') && pr2(array("i","u","f","x"),$hlplus,blank(0),array("e","o","ar","al"),$hlplus,blank(0),$text)!==$text  && $didhI!==1)
{
...
/* pugantalaghUpadhasya ca (7.3.86) */
elseif ( (pr2(array("vid"),array("+"),$pit_sArvadhAtuka_pratyayas,array("ved"),array("+"),$pit_sArvadhAtuka_pratyayas,$text)!== $text || pr2(array("vid"),array("+"),blank(0),array("ved"),array("+"),blank(0),$text)!== $text) && ends(array($fo),array("vida!"),4)  && $didhI!==1)
{
...
/* sArvadhAtukArdhadhAtukayoH (7.3.84) */
elseif ( pr2(array("nu+"),$pit_sArvadhAtuka_pratyayas,blank(0),array("no+"),$pit_sArvadhAtuka_pratyayas,blank(0),$text) !== $text && $didhI!==1 )
{
...
/* cisphurorNau (6.1.53) */
if (sub(array("ce","sPor"),array("+"),array("i+"),0) && ends(array($fo),array("ciY","sPura!"),4) && in_array($so,$tiG) )
{
...
/* sArvadhAtukArdhadhAtukayoH (7.3.84) */
if ( sub(array("i","I","u","U","f","F","x","X"),array("+"),array("u+","I+","a+",),0) && ($sarvadhatuka===1 || $ardhadhatuka===1) && !($ad===1 && sub(array("i","I","u","U","f","F","x","X"),array("+"),$ajAdi_apit_sArvadhAtuka_pratyayas,0) )  && $didhI!==1 && $kGiti!==1)
{
...
/* sArvadhAtukArdhadhAtukayoH (7.3.84) */
// for curAdis.
if ( sub($hl,array("i+"),array("a+"),0) && $vik===array("Sap")  && $didhI!==1 )
{
...
/* sArvadhAtukArdhadhAtukayoH (7.3.84) */
if ( pr2($hl,array("+u+"),$pit_sArvadhAtuka_pratyayas,$hl,array("+o+"),$pit_sArvadhAtuka_pratyayas,$text) !== $text  && $didhI!==1 )
{
...
/* sArvadhAtukArdhadhAtukayoH (7.3.84) */
if ( pr2(array("i","I","u","U","f","F","x","X",),array("+I+"),$halAdi_pit_sArvadhAtuka_pratyayas,array("e","e","o","o","ar","ar","al","al",),array("+I"),$halAdi_pit_sArvadhAtuka_pratyayas,$text)!==$text && ($sarvadhatuka===1 || $ardhadhatuka===1)   && $didhI!==1)
{
...
/* sArvadhAtukArdhadhAtukayoH (7.3.84) */
if ( pr2(array("i","I","u","U","f","F","x","X",),array("+"),$halAdi_pit_sArvadhAtuka_pratyayas,array("e","e","o","o","ar","ar","al","al",),array("+"),$halAdi_pit_sArvadhAtuka_pratyayas,$text)!==$text && ($sarvadhatuka===1 || $ardhadhatuka===1)   && $didhI!==1)
{
...
/* sArvadhAtukArdhadhAtukayoH (7.3.84) */
if ( pr2(array("i","I","u","U","f","F","x","X",),array("+"),$ArdhadhAtuka_tiG_pratyayas,array("e","e","o","o","ar","ar","al","al",),array("+"),$ArdhadhAtuka_tiG_pratyayas,$text)!==$text && $ardhadhatuka===1  && $didhI!==1  && $kGiti!==1 && $sIyuT!==1)
{
    ...
    echo "<p class = sa >sArvadhAtukArdhadhAtukayoH (".link_sutra("7.3.84").") 11111:</p>\n"; 
    echo "<p class = sa >सार्वधातुकार्धधातुकयोः (७.३.८४) :</p>\n";
    display(0);    
}
/* bhUsuvostiGi (7.3.88) */
...
/* sArvadhAtukArdhadhAtukayoH (7.3.84) */
elseif ( pr2(array("i","I","u","U","f","F","x","X",),array("+"),$ajAdi_pit_sArvadhAtuka_pratyayas,array("e","e","o","o","ar","ar","al","al",),array("+"),$ajAdi_pit_sArvadhAtuka_pratyayas,$text)!==$text && ($sarvadhatuka===1 || $ardhadhatuka===1)   && $didhI!==1)
{
...
/* vibhASA lIyateH (6.1.50) */
if (sub(array("le"),array("+"),blank(0),0) && ((ends(array($fo),array("lI"),4) && $verbset==="kryAdi") || (ends(array($fo),array("lIN"),4) && $verbset==="none") ))
{
    $text=three(array("le"),array("+"),blank(0),array("lA"),array("+"),blank(0),1);    
    echo "<p class = sa >By vibhASA lIyateH (".link_sutra("6.1.50").") 2:</p>\n"; 
    echo "<p class = sa >विभाषा लीयतेः (६.१.५०) :</p>\n";
    display(0);
}
...
if ((ends(array($fo),array("vfN","vfY"),4) || ends(array($fo),array("F"),1)) && in_array($so,$taG) && ($sic===1||$sIyuT===1) )
{
    ...
    echo "<p class = sa >By liGsicorAtmanepadeSu (".link_sutra("7.2.42").") :</p>\n"; 
    echo "<p class = sa >लिङ्सिचोरात्मनेपदेषु (७.२.४२) :</p>\n";
    display(0);
...
/* uzca (1.2.12) */
if (ends(array($verb_without_anubandha),array("f",),1) && in_array($so,$taG) && ($sic===1||$sIyuT===1) )
{
	...
	if ( sub(array("f"),array("+"),array("isI"),0) && ($sarvadhatuka===1 || $ardhadhatuka===1) && !($ad===1 && sub(array("i","I","u","U","f","F","x","X"),array("+"),$ajAdi_apit_sArvadhAtuka_pratyayas,0) )  && $didhI!==1)
	{
		$text=three(array("f"),array("+"),array("isI"),array("ar"),array("+"),array("isI"),0);
		echo "<p class = sa >sArvadhAtukArdhadhAtukayoH (".link_sutra("7.3.84").") :</p>\n"; 
		echo "<p class = sa >सार्वधातुकार्धधातुकयोः (७.३.८४) :</p>\n";
		display(0);    
	}
...
/* sArvadhAtukArdhadhAtukayoH (7.3.84) */
if ( sub(array("i","I","u","U","f","F","x","X"),array("+"),array("sI"),0) && ($sarvadhatuka===1 || $ardhadhatuka===1) && !($ad===1 && sub(array("i","I","u","U","f","F","x","X"),array("+"),$ajAdi_apit_sArvadhAtuka_pratyayas,0) )  && $didhI!==1 && $kGiti!==1)
{
    $text=three(array("i","I","u","U","f","F","x","X",),array("+"),array("sI"),array("e","e","o","o","ar","ar","al","al",),array("+"),array("sI"),0);
    echo "<p class = sa >sArvadhAtukArdhadhAtukayoH (".link_sutra("7.3.84").") :</p>\n"; 
    echo "<p class = sa >सार्वधातुकार्धधातुकयोः (७.३.८४) :</p>\n";
    display(0);    
}
/* pugantalaghUpadhasya ca (7.3.86) */
if ( $atolopa!==1 && $ardhadhatuka===1 && arr($text,'/[iufxIUFX]['.pc('hl').'][+][s][I][y][+]/') && !arr($text,"/[+][i][y][+][t]$/")  && $didhI!==1 && $sIyuT===1 && $kGiti!==1)
{
    $text=three(array("i","u","f","x","I","U","F","X",),$hl,array("+sI"),array("e","o","ar","al","e","o","ar","al",),$hl,array("+sI"),0);
    echo "<p class = sa >pugantalaghUpadhasya ca (7.3.86) :</p>\n"; 
...
if ($id_dhAtu==="sew" && $id_pratyaya==="sew" && !($yAsuT===1 && $lakAra==="ASIrliN")  && !in_array("iw",$Agama)) // for seT dhAtus
{
    $text=one(array("+"),array("+i"),0);
	// Removing unwanted iDAgama which happenned accidentally
	$text = one(array("+iyAs+"),array("+yAs+"),0);
    echo "<p class = sa >By doing iDAgama :</p>\n"; 
    echo "<p class = sa >इडागमे कृते :</p>\n";
    display(0);
	$Agama=array_merge($Agama,array("iw"));
}
if ($id_dhAtu==="vew" && $id_pratyaya==="sew" && !($yAsuT===1 && $lakAra==="ASIrliN")  && !in_array("iw",$Agama)) // for veT dhAtus optional one.
{
    $text=one(array("+"),array("+i"),1);
	$text = one(array("tfap+isya","dfap+isya","gopAya+sya"),array("tfap+sya","dfap+sya","gopAya+isya"),0); // for veT dhAtus tRp and dRp - iDAgama doesn't apply after amAgama.
	// Removing unwanted iDAgama which happenned accidentally
	$text = one(array("+iyAs+"),array("+yAs+"),0);
    echo "<p class = sa >By doing iDAgama :</p>\n"; 
    echo "<p class = sa >इडागमे कृते :</p>\n";
...
/* ato lopaH (6.4.48) */
if ( sub(array("Aya"),array("+isya"),blank(0),0) || sub(array("a"),array("+i"),blank(0),0) )
{ 
	$text = two(array("Aya"),array("+isya"),array("Ay"),array("+isya"),0);
...
if ( sub(array("grah"),array("+"),array("i"),0) && ends(array($fo),array("graha!"),4) )
{ 
...
if ( sub(array("goh"),array("+"),$ac,0) && ends(array($fo),array("guhU!"),4) )
{ 
    $text = three(array("goh"),array("+"),$ac,array("gUh"),array("+"),$ac,0);
...
$vras=0;
$vrasca = array("vfSc","sfj","mfj","yaj","rAj","BrAj","devej","parivrAj","Bfj","ftvij","mArj","vraSc","Brasj");
$vrashca = array("vfSz","sfz","mfz","yaz","rAz","BrAz","devez","parivrAz","Bfz","ftviz","mArz","vraSz","Brasz");
if ( sub($vrasca,array("+"),prat("Jl"),0)  && in_array($so,$tiG) && ends(array($fo),array("o!vraScU!","sfja!","mfja!","yaja!","rAjf!","wuBrAjf!","Bfja!","mfja!","Brasja!"),4))
{
...
/* naho dhaH (8.2.35) */
if (sub(array("nah"),blank(0),blank(0),0) && ends(array($fo),array("Raha!"),2) && (arr($text,'/[+]$/') || arr($text,'/[+]['.pc("Jl").']/')) )
{
...
/* vibhASeTaH (8.3.80) */
if( in_array($so,$tiG) && (sub($iN2,array("+izIDv"),blank(0),0) || (sub($iN2,array("+iDv"),blank(0),0) && in_array($lakAra,array("luN","liw")) )) )
{
...
elseif( in_array($so,$tiG) && (sub($iN2,array("zIDv"),blank(0),0) || (sub($iN2,array("Dv"),blank(0),0) && in_array($lakAra,array("luN","liw")) )) )
{
