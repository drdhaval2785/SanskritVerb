...
if ( (in_array("N",$itpratyaya)||in_array("k",$itpratyaya) ) && sub(array("A+"),blank(0),blank(0),0) && $lakAra!=="" && $caG===1)
{
...
/* Ato lopa iTi ca (7.4.64) */
elseif ( (in_array("N",$itpratyaya)||in_array("k",$itpratyaya) ) && sub(array("A+"),blank(0),blank(0),0) && $lakAra!=="" )
{
