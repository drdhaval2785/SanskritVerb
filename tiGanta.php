...
{
    $ardhadhatuka=1;
    echo "<p class = pa >By ArdhadhAtukaM zeSaH (3.4.114) :</p>"; 
...
if ( sub(array("gupU!","viCa!","pana!"),array("+"),$sArvadhAtuka_pratyayas,0) || (sub(array("DUpa!"),array("+"),$sArvadhAtuka_pratyayas,0) && $verbset==="BvAdi") || $_GET['cond49']==="1"  )
{
    ...
    echo "<p class = sa >By gupUdhUpavicCipaNipanibhya AyaH (3.1.28) :</p>"; 
...
if ( ends(array($fo),array("fta!"),4) && $pada==="pratyaya" && $lakAra!=="")
{
    ...
    echo "<p class = st >By RterIyaG (3.1.29) :</p>"; 
...
if ( ends(array($fo),array("kamu!"),4) && $pada==="pratyaya" && $lakAra!=="")
{
    ...
    echo "<p class = st >By kamerNiG (3.1.30) :</p>"; 
...
if ( in_array($sanAdi,array("Aya","IyaN","RiN")) && sub(array("Aya","IyaN","RiN"),array("+"),$ArdhadhAtuka_pratyayas,0) && $lakAra!=="")
{
    ...
    echo "<p class = st >By AyAdaya ArdhadhAtuke vA (3.1.31) :</p>"; 
...
if (sub(array("yasu!"),array("+Syan"),array("+"),0) && ends(array($fo),array("yasu!"),2))
{
    ...
    echo "<p class = sa >By yaso'nupasargAt (3.1.71) :</p>"; 
...
if (sub($juhotyAdi,array("+Sap+"),$tiG,0) && ends(array($fo),$juhotyAdi,4) && $sarvadhatuka===1)
{
    ...
    if ($zlu===1)
    {
        ...
        if(sub(array("quBfY","mAN","o!hAN"),array("+"),blank(0),0))
        {
            ...
            echo "<p class = sa >By zlau (6.1.10) and bhRJAmit (7.4.76) :</p>"; 
        ...
        elseif(sub(array("f","pipF",),array("+"),blank(0),0))
        {
            ...
            echo "<p class = sa >By zlau (6.1.10) and artipipartyozca (7.4.77) :</p>"; 
        ...
        elseif(sub(array("Riji!r","viji!r","vizx!"),array("+"),blank(0),0))
        {
            ...
            echo "<p class = sa >By zlau (6.1.10) and nijAM trayANAM guNaH zlau (7.4.75) :</p>"; 
...
if ( pratyayareplace2(array("+"),$apit_sArvadhAtuka_pratyayas,blank(0),array("+fadfad"),$apit_sArvadhAtuka_pratyayas,blank(0),$text)!== $text )
{
    ...
    display(0); 
    echo "<p class = sa >By kGiti ca (1.1.5) 2:</p>"; 
...
if (sub(array("mIN",),$shitpratyaya,blank(0),0) && ends(array($fo),array("mIN"),4) && in_array($so,$tiG) && $veda===1)
{
    ...
    echo "<p class = sa >By mInAternigame (7.3.81) :</p>";
...
if ( in_array($lakAra,array("viDiliN","ASIrliN")) && in_array($so,$tis) )
{
    ...
    echo "<p class = sa >By yAsuT parasmaipadeSUdAtto Gicca (3.4.103) :</p>";
...
if ( in_array($lakAra,array("viDiliN","ASIrliN")) && sub(array("+"),array("t","T"),blank(0),0) )
{
    ...
    echo "<p class = sa >By suT tithoH (3.4.107) :</p>";
...
if ( in_array($lakAra,array("viDiliN")) && sub(array("+yA"),array("+"),blank(0),0))
{
    ...
    echo "<p class = sa >By ato yeyaH (7.2.80) :</p>";
    echo "<p class = sa >अतो येयः (७.२.८०) :</p>";  
    display(0);
}
/* syatAsI lRlutoH (3.1.33) */
if ( pratyayareplace2(array("+"),blank(0),$tiG1,array("+"),array("sya"),$tiG1,$text)!==$text && in_array($lakAra,array("lfw","lfN")) )
{
    $text=pratyayareplace2(array("+"),blank(0),$tiG1,array("+"),array("sya"),$tiG1,$text);
    echo "<p class = sa >By syatAsI lRlutoH (3.1.33) :</p>";
    echo "<p class = sa >स्यतासी लृलुटोः (३.१.३३) (३.४.३३) :</p>";  
    display(0);
}
/* syatAsI lRlutoH (3.1.33) */
// Not clear whether it is tAs or tA.
if ( pratyayareplace2(array("+"),blank(0),$tiG1,array("+"),array("tA"),$tiG1,$text)!==$text && in_array($lakAra,array("luw")) )
{
    $text=pratyayareplace2(array("+"),blank(0),$tiG1,array("+"),array("tA"),$tiG1,$text);
    echo "<p class = sa >By syatAsI lRlutoH (3.1.33) :</p>";
    echo "<p class = sa >स्यतासी लृलुटोः (३.१.३३) (३.४.३३) :</p>";  
    display(0);
}
...
// for sya Agama.
if (sub(array("sya"),array("m","v"),blank(0),0) && $pada === "pratyaya" && in_array($so,$tiG) )
{
    $text = two(array("sya"),array("m","v"),array("syA"),array("m","v"),0);
...
if ( $lakAra==="low" && sub(array("+"),array("tas","Tas","Ta","mi","vas","mas"),blank(0),0))
{
    ...
    echo "<p class = sa >By loTo laGvat (3.4.85) :</p>";
...
if ( pratyayareplace2(array("+"),array("tu","hi"),blank(0),array("+"),array("tAt","tAt"),blank(0),$text)!==$text && in_array($so,$tiG) )
{
    ...
    $text = array_merge($text,$text1);
    echo "<p class = sa >By tuhyostAtaGGAziSyanyatarsyAm (7.1.35) :</p>"; 
...
if ($rudhAdibhyaH===1)
{
    ...
    if (arr($text,'/[n][a][n]/'))
    {
        ...
        echo "<p class = sa >By znAnnalopaH (6.4.23) :</p>";
...
if (ends(array($fo),array("dviza!"),4) && pratyayareplace2(array("dviz"),array("+"),array("an"),array("dviz"),array("+"),array("us"),$text)!==$text && in_array($so,$tiG) && $lakAra==="laN")
{
    ...
    $text = array_merge($text,$text1);
    echo "<p class = sa >By dviSazca (3.4.112) :</p>"; 
...
if ( pratyayareplace2(array("SAs"),array("+"),$halAdi_apit_sArvadhAtuka_pratyayas,array("Sis"),array("+"),$halAdi_apit_sArvadhAtuka_pratyayas,$text)!==$text && ends(array($fo),array("SAsu!"),4) && in_array($so,$tiG) && $sarvadhatuka===1)
{
    ...
    echo "<p class = sa >By zAsa idaGhaloH (6.4.34) :</p>";
...
if ( sub(array("Sis","us"),array("+"),blank(0),0) && ends(array($fo),array("SAsu!","vasa!",),4) && in_array($so,$tiG) && $sarvadhatuka===1)
{
    ...
    echo "<p class = sa >By zAsivasighasInAM ca (8.3.60) :</p>";
...
if ( pratyayareplace2(array("vid"),array("+"),array("an"),array("vid"),array("+"),array("us"),$text)!==$text && ends(array($fo),array("vida!"),4) && in_array($so,$tiG) && $verbset==="adAdi" && $lakAra==="laN")
{
    ...
    echo "<p class = sa >By sijabhyastavidibhyazca (3.4.109) :</p>";
...
if ( pratyayareplace2(array("mfj"),array("+"),$pit_sArvadhAtuka_pratyayas,array("mArj"),array("+"),$pit_sArvadhAtuka_pratyayas,$text)!==$text && in_array($so,$tiG))
{
    ...
    echo "<p class = sa >By mRjervRddhiH (7.2.114) :</p>"; 
...
if ( pratyayareplace2(array("mfj"),array("+"),$ajAdi_apit_sArvadhAtuka_tiG_pratyayas,array("mArj"),array("+"),$ajAdi_apit_sArvadhAtuka_tiG_pratyayas,$text)!==$text && in_array($so,$tiG))
{
    ...
    echo "<p class = sa >By mRjervRddhiH (7.2.114) and kGityajAdu veSyate :</p>"; 
...
if ( sub(array("brU"),array("+"),array("ti","tas","anti","si","Tas"),0) && $lakAra==="law" )
{
    ...
    echo "<p class = sa >By bruvaH paYcAnAmAdita Aho bruvaH (3.4.84) :</p>";
...
if ( sub(array("Ah"),array("+"),array("Tal"),0) && $lakAra==="law" )
{
    ...
    echo "<p class = sa >By AhasthaH (8.2.35) :</p>";
...
if ( pratyayareplace2(array("brU"),array("+"),$halAdi_pit_sArvadhAtuka_tiG_pratyayas,array("brU"),array("+I+"),$halAdi_pit_sArvadhAtuka_tiG_pratyayas,$text)!==$text && ends(array($fo),array("brUY"),4) && in_array($so,$tiG) )
{
    ...
    echo "<p class = sa >By bruva IT (7.3.93) :</p>";
...
{
    echo "<p class = sa >By guNo'pRkte (7.3.91) :</p>"; 
...
elseif ( sub(array("UrRu+"),$halAdi_pit_sArvadhAtuka_pratyayas,blank(0),0) && ends($vik,array("Slu","Sapluk"),1))
{
    ...
    echo "<p class = sa >By UrNotervibhASA (7.3.90) :</p>"; 
...
elseif ( pratyayareplace2(array("u+"),$halAdi_pit_sArvadhAtuka_pratyayas,blank(0),array("O+"),$halAdi_pit_sArvadhAtuka_pratyayas,blank(0),$text)!==$text && ends($vik,array("Sapluk"),1))
{
    ...
    echo "<p class = sa >By uto vRddhirluki hali (7.3.89) :</p>"; 
...
if ($abhyasta===1 && pratyayareplace2(array("+"),array("anti","antu","an"),blank(0),array("+"),array("ati","atu","us"),blank(0),$text)!==$text)
{
    ...
    echo "<p class = sa >By adabhyastAt (7.1.4) :</p>";
...
if (sub(array("daridrA"),array("+"),$halAdi_apit_sArvadhAtuka_pratyayas,0) )
{
    ...
    echo "<p class = sa >By iddaridrasya (6.1.114) :</p>";
...
if (sub(array("F"),$hl,array("+"),0) && in_array($so,$tiG)) 
{
    ...
    echo "<p class = sa >By upadhAyAzca (7.1.101) :</p>"; 
...
if ( $lakAra!=="" && sub($tudAdi_mucAdi,array("+"),array("a+"),0) && ($verbset==="tudAdi" || ($verbset==="none" && ends(array($fo),$tudAdi,4)) ) )
{
    ...
    echo "<p class = sa >By ze mucAdInAm (7.1.59) :</p>";
...
if (sub(array("raD","jaB"),array("+"),$ac,0) && ends(array($fo),array("raDa!","jaBa!"),4) )
{
    ...
    echo "<p class = sa >By radhijabhoraci (7.1.61) :</p>"; 
...
{ 
    ...
    echo "<p class = sa >By UdupadhAyA gohaH (6.4.89) :</p>";
...
{ 
    $text = three(array("A"),$hl,array("+Ri+"),array("a"),$hl,array("+Ri+"),0);
    echo "<p class = sa >By mitAM hrasvaH (6.4.92) :</p>";
...
if ( ends(array($fo),array("Gasa!","Basa!"),4) && pratyayareplace2(array("Gas","Bas"),array("+"),$apit_sArvadhAtuka_pratyayas,array("Gs","Bs"),array("+"),$apit_sArvadhAtuka_pratyayas,$text)!==$text && $lakAra!=="" )
{
    ...
    echo "<p class = sa >By ghasibhasorhali ca (6.4.100) :</p>"; 
...
elseif ( sub(array("mid"),array("+"),blank(0),0) && ends(array($fo),array("mida!"),4))
{
    ...
    echo "<p class = sa >By miderguNaH (7.3.82) :</p>"; 
...
if ( sub(array("SI"),array("+"),$sArvadhAtuka_pratyayas,0) && in_array($so,$tiG) )
{
    ...
    echo "<p class = sa >By zIGaH sArvadhAtuke guNaH (7.4.21) :</p>"; 
...
if ( sub(array("Se"),array("+"),array("ate","ata","atAm"),0) && in_array($so,$tiG) )
{
    ...
    echo "<p class = sa >By zIGo ruT (7.1.6) :</p>"; 
...
if ( sub(array("vid"),array("+"),array("ate","ata","atAm"),0) && in_array($so,$tiG) && $verbset==="adAdi" )
{
    ...
    echo "<p class = sa >By vettervibhASA (7.1.7) :</p>"; 
...
/* pugantalaghUpadhasya ca (7.3.86) */
elseif ( pratyayareplace2(array("i","u","f","x"),$hl,$ArdhadhAtuka_tiG_pratyayas,array("e","o","ar","al"),$hl,$ArdhadhAtuka_tiG_pratyayas,$text)!==$text && $atolopa!==1 && ($sarvadhatuka===1 || $ardhadhatuka===1) && arr($text,'/[iufx]['.pc('hl').'][+]/') && $kGiti!==1)
{
    $text=pratyayareplace2(array("i","u","f","x"),$hl,$ArdhadhAtuka_tiG_pratyayas,array("e","o","ar","al"),$hl,$ArdhadhAtuka_tiG_pratyayas,$text);
    echo "<p class = sa >pugantalaghUpadhasya ca (7.3.86) :</p>"; 
...
{
    echo "<p class = sa >By nAbhyastasyAci piti sArvadhAtuke (7.3.87) :</p>"; 
...
/* pugantalaghUpadhasya ca (7.3.86) */
elseif ( $atolopa!==1 && $ardhadhatuka===1 && arr($text,'/[iufx]['.pc('hl').'][+]/') && pratyayareplace2(array("i","u","f","x"),$hlplus,$ArdhadhAtuka_pratyayas,array("e","o","ar","al"),$hlplus,$ArdhadhAtuka_pratyayas,$text)!==$text && !arr($text,"/[+][i][y][+][t]$/"))
{
    $text=pratyayareplace2(array("i","u","f","x"),$hlplus,$ArdhadhAtuka_pratyayas,array("e","o","ar","al"),$hlplus,$ArdhadhAtuka_pratyayas,$text);
    echo "<p class = sa >pugantalaghUpadhasya ca (7.3.86) :</p>"; 
    echo "<p class = sa >पुगन्तलघूपधस्य च (७.३.८६) 3:</p>";
    display(0);    
}
...
if (ends(array($fo),array("qukfY","kfY"),4))
{
    ...
    if (sub(array("kur+u"),array("+"),array("v","m"),0))
    {
        ...
        echo "<p class = sa >By nityaM karoteH (6.4.108) :</p>"; 
    ...
    if (sub(array("kur+u"),array("+"),array("y"),0))
    {
        ...
        echo "<p class = sa >By ye ca (6.4.109) :</p>"; 
...
if ( sub(array("i","I","u","U","f","F","x","X"),array("+"),array("u+","I+","a+"),0) && ($sarvadhatuka===1 || $ardhadhatuka===1) && !($ad===1 && sub(array("i","I","u","U","f","F","x","X"),array("+"),$ajAdi_apit_sArvadhAtuka_pratyayas,0) ) )
{
    ...
    echo "<p class = sa >sArvadhAtukArdhadhAtukayoH (7.3.84) 4:</p>"; 
    echo "<p class = sa >सार्वधातुकार्धधातुकयोः (७.३.८४) :</p>";
    display(0);    
}
/* sArvadhAtukArdhadhAtukayoH (7.3.84) */
...
if ( pratyayareplace2($hl,array("+u+"),$pit_sArvadhAtuka_pratyayas,$hl,array("+o+"),$pit_sArvadhAtuka_pratyayas,$text) !== $text )
{
    ...
    echo "<p class = sa >sArvadhAtukArdhadhAtukayoH (7.3.84) 3:</p>"; 
    echo "<p class = sa >सार्वधातुकार्धधातुकयोः (७.३.८४) :</p>";
    display(0);    
}
/* sArvadhAtukArdhadhAtukayoH (7.3.84) */
if ( pratyayareplace2(array("i","I","u","U","f","F","x","X",),array("+I+"),$halAdi_pit_sArvadhAtuka_pratyayas,array("e","e","o","o","ar","ar","al","al",),array("+I"),$halAdi_pit_sArvadhAtuka_pratyayas,$text)!==$text && ($sarvadhatuka===1 || $ardhadhatuka===1)  )
{
    ...
    echo "<p class = sa >sArvadhAtukArdhadhAtukayoH (7.3.84) 6:</p>"; 
    echo "<p class = sa >सार्वधातुकार्धधातुकयोः (७.३.८४) :</p>";
    display(0);    
}
/* sArvadhAtukArdhadhAtukayoH (7.3.84) */
...
/* sArvadhAtukArdhadhAtukayoH (7.3.84) */
if ( pratyayareplace2(array("i","I","u","U","f","F","x","X",),array("+"),$ArdhadhAtuka_tiG_pratyayas,array("e","e","o","o","ar","ar","al","al",),array("+"),$ArdhadhAtuka_tiG_pratyayas,$text)!==$text && $ardhadhatuka===1  )
{
    $text=pratyayareplace2(array("i","I","u","U","f","F","x","X",),array("+"),$ArdhadhAtuka_tiG_pratyayas,array("e","e","o","o","ar","ar","al","al",),array("+"),$ArdhadhAtuka_tiG_pratyayas,$text);
    echo "<p class = sa >sArvadhAtukArdhadhAtukayoH (7.3.84) 1:</p>"; 
    echo "<p class = sa >सार्वधातुकार्धधातुकयोः (७.३.८४) :</p>";
    display(0);    
}
...
{
    echo "<p class = sa >By bhUsuvostiGi (7.3.88) :</p>"; 
...
elseif ( pratyayareplace2(array("i","I","u","U","f","F","x","X",),array("+"),$ajAdi_pit_sArvadhAtuka_pratyayas,array("e","e","o","o","ar","ar","al","al",),array("+"),$ajAdi_pit_sArvadhAtuka_pratyayas,$text)!==$text && ($sarvadhatuka===1 || $ardhadhatuka===1)  )
{
    ...
    echo "<p class = sa >sArvadhAtukArdhadhAtukayoH (7.3.84) 5:</p>"; 
    echo "<p class = sa >सार्वधातुकार्धधातुकयोः (७.३.८४) :</p>";
    display(0);    
}
/* hali ca (8.2.77) */
if ( sub(array("i","u","f"),array("r+","v+"),$halAdi_apit_sArvadhAtuka_pratyayas,0) && in_array($so,$tiG) && $karoti!==1 )
{
    ...
    echo "<p class = sa >By hali ca (8.2.77) 2:</p>"; 
...
if ( pratyayareplace2(array("gam","han","jan","Gas","Kan"),array("+"),$ajAdi_apit_sArvadhAtuka_pratyayas,array("gm","hn","jn","Gs","Kn"),array("+"),$ajAdi_apit_sArvadhAtuka_pratyayas,$text)!==$text && in_array($so,$tiG) && ends(array($fo),array("gamx!","hana!","jana!","Gasa!","Kanu!"),4))
{
    ...
    echo "<p class = sa >By gamahanajanaghasAM lopaH kGiti (6.4.98) :</p>"; 
...
if ( pratyayareplace2(array("rod","svap","Svas","prAR","an","jakz","rud"),array("+"),array("t","s"),array("rod","svap","Svas","prAR","an","jakz","rud"),array("+"),array("at","as"),$text)!==$text && in_array($so,$tiG) && ends(array($fo),array("rudi!r","Yizvapa!","zvapa!","Svasa!","prARa!","ana!","jakza!"),4))
{
    ...
    $text = array_merge($text,$text1);
    echo "<p class = sa >By aDgArgyagAlavayoH (7.3.99) :</p>"; 
...
if ( pratyayareplace2(array("rod","svap","Svas","prAR","an","jakz","rud"),array("+"),array("t","s"),array("rod","svap","Svas","prAR","an","jakz","rud"),array("+"),array("It","Is"),$text)!==$text && in_array($so,$tiG) && ends(array($fo),array("rudi!r","Yizvapa!","zvapa!","Svasa!","prARa!","ana!","jakza!"),4))
{
    ...
    echo "<p class = sa >By rudazca paJcabhyaH (7.3.98) :</p>"; 
...
if ( sub(array("rod","svap","Svas","prAR","an","jakz","rud"),array("+"),prat('vl'),0) && in_array($so,$tiG) && ends(array($fo),array("rudi!r","Yizvapa!","zvapa!","Svasa!","prARa!","ana!","jakza!"),4))
{
    ...
    echo "<p class = sa >By rudAdibhyaH sArvadhAtuke (7.2.76) :</p>"; 
...
if ( sub(array("han"),array("+"),array("hi"),0) && in_array($so,$tiG) )
{
    ...
    echo "<p class = sa >By hanterjaH (6.4.36) 1:</p>";
...
if ( pratyayareplace2(array("han","gam","jan","Kan","Gas"),array("+"),$ajAdi_apit_sArvadhAtuka_pratyayas,array("hn","gm","jn","Kn","Gs"),array("+"),$ajAdi_apit_sArvadhAtuka_pratyayas,$text)!==$text && in_array($so,$tiG) )
{
    ...
    echo "<p class = sa >By gamahanajanakhanaghasAM kGityanaGi (6.4.98) :</p>";
...
if ( sub(array("v","y"),array("+"),prat("vl"),0) )
{
    ...
    echo "<p class = sa >By lopo vyorvali (6.4.65) :</p>";
...
echo "<p class = sa >By jhalo jhali (8.2.26) :</p>";
...
if ( sub(prat('Jz'),array("+"),array("t","T"),0) && !sub(array("daD"),array("+"),array("t","T"),0) && in_array($so,$tiG))
{
    ...
    echo "<p class = sa >By jhaSastathordho'dhaH (8.2.40) :</p>";
...
{
    echo "<p class = sa >By na mAGyoge (6.4.74) :</p>"; 
...
elseif ( in_array($lakAra,array("luN","laN","lfN",)) && arr($text,'/^['.pc('ac').']/') )
{
    ...
    echo "<p class = sa >By ADajAdInAm (6.4.72) :</p>"; 
...
{
    $text=Adyanta($text,"a",1);
    echo "<p class = sa >By luGlaGlRGkSvaDudAttaH (6.4.71) :</p>"; 
...
if ($id_dhAtu==="sew" && $id_pratyaya==="sew")
{
    $text=one(array("+"),array("+i"),0);
...
if ( sub($ac,array("+"),array("nu+hi"),0) && in_array($so,$tiG) )
{
    ...
    echo "<p class = sa >By utazca pratyayAdasaMyogapUrvAt (6.4.106) :</p>"; 
...
if ( sub(array("A"),array("+"),array("an"),0) && in_array($so,array("Ji")) && $lakAra==="laN")
{
    ...
    echo "<p class = sa >By laGaH zAkaTAyanasyaiva (3.4.111) :</p>"; 
...
if ( sub($ac,array("+nu+"),array("vas","mas","vahe","mahe","va","ma","vahi","mahi",),0) && in_array($so,$tiG) )
{
    ...
    echo "<p class = sa >By lopazcAsyAnyatarasyAM mvoH (6.4.107) :</p>"; 
...
if ( sub($hl,array("+"),array("nA+hi"),0) && in_array($so,$tiG) )
{
    ...
    echo "<p class = sa >By halaH znaH zAnajJau (3.1.83) :</p>"; 
...
if ( sub($hl,array("+"),array("Ana+hi"),0) && in_array($so,$tiG) && $veda===1)
{
    ...
    echo "<p class = sa >By Chandasi zAnajapi (3.1.81) :</p>"; 
...
if ( sub(array("a+"),array("hi"),blank(0),0) && in_array($so,$tiG) && $hanterjaH!==1 )
{
    ...
    echo "<p class = sa >By ato heH (6.4.105) :</p>"; 
...
if ( sub(array("jahA"),array("+"),array("y"),0) && (in_array("N",$it)||in_array("k",$it)) && $sarvadhatuka===1 )
{
    ...
    echo "<p class = sa >By lopo yi (6.4.118) :</p>"; 
...
if ( sub(array("jahA"),array("+"),$halAdi_apit_sArvadhAtuka_pratyayas,0) && (in_array("N",$it)||in_array("k",$it)) && $abhyasta===1)
{
    ...
    echo "<p class = sa >By jahAtezca (6.4.116) :</p>"; 
...
if ( sub(array("jahI"),array("+"),array("hi"),0) && (in_array("N",$it)||in_array("k",$it)) && $abhyasta===1)
{
    ...
    echo "<p class = sa >By A ca hau (6.4.115) :</p>"; 
...
echo "<p class = sa >By IDajanordhve ca (7.2.78) :</p>";
echo "<p class = sa >ईडजनोर्ध्वे च (७.२.७८) :</p>";
display(0);
}
/* AdezapratyayayoH (8.3.59) */
if(Adezapratyaya!==$text && in_array($so,$tiG))
{
...
display(0);*/
    $text = Adezapratyaya(); // created a new function on 15/12/2014
}
/* halGyAbbhyo dIrghAtsutisyapRktaM hal (6.1.68) and apRkta ekAlpratyayaH (1.2.41) */
// GyAp pending. only hal handled now.
...
if ( arr($text,'/[s]$/') && $so==='tip' && $lakAra==="laN")
{
    ...
    echo "<p class = sa >By tipyanasteH (8.2.73) :</p>";
...
if ( arr($text,'/[d]$/') && $so==='sip' && $lakAra==="laN")
{
    ...
    echo "<p class = sa >By dazca (8.2.75) :</p>";
...
if ( arr($text,'/[s]$/') && $so==='sip' && $lakAra==="laN" && $halGyAbbhyo===1)
{
    ...
    $text = array_merge($text2,$text1);
    echo "<p class = sa >By sipi dhAto rurvA (8.2.74) :</p>";
...
if ($dhatu===1 && sub($ik,array("r","v"),$hl,0) && (arr($text,'/[rv][+]/')|| arr($text,'/[v][n][+]/') ) && $karoti!==1)
{
    ...
    echo "<p class = sa >By hali ca (8.2.77) 3:</p>";
    echo "<p class = sa >हलि च (८.२.७७) :</p>"; 
    if ($allopo===1)
    {
