...
/* NeraniTi (6.4.51) */
if (arr($text,'/i\+a/') && in_array($so,$tiG) && $lakAra==="luN" && $caG===1 && (in_array("iw",$Agama)||ends(array($sanAdi),array("Ric","RiN"),2)) )
{
...
if (arr($text,'/u/') && sub(array("Sam","kim","tvam","tad"),array("u"),$ac,0))
{
