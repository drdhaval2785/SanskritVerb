...
$otherdata=array("~1:vaceH praTamapauruzabahuvacanarUpaM nAsti:वच्‌ धातु का प्रथम पुरुष बहुवचन का रूप नहीं होता है ।","~2:antimaM rUpam:अन्तिमं रूपम्‌");
...
function generatesutrainfo()
{
	...
	foreach($ASdata as $asd){
		$split = explode(':', $asd);
		$result[$split[0]] = str_replace('!', '~', convert1($split[2]));
	}
	foreach($vdata as $asd){
		$split = explode(':', $asd);
		$result[$split[0]] = str_replace('!', '~', $split[1]);
	}
...
//generatesutrainfo();
function decidepurushavachana($suffix)
{
	$suffixarray = array('tip' => array('purusha' => 'praTama', 'vachana' => 'eka'),
						'tas' => array('purusha' => 'praTama', 'vachana' => 'dvi'),
						'Ji' => array('purusha' => 'praTama', 'vachana' => 'bahu'),
						'sip' => array('purusha' => 'maDyama', 'vachana' => 'eka'),
						'Tas' => array('purusha' => 'maDyama', 'vachana' => 'dvi'),
						'Ta' => array('purusha' => 'maDyama', 'vachana' => 'bahu'),
						'mip' => array('purusha' => 'uttama', 'vachana' => 'eka'),
						'vas' => array('purusha' => 'uttama', 'vachana' => 'dvi'),
						'mas' => array('purusha' => 'uttama', 'vachana' => 'bahu'),
						'ta' => array('purusha' => 'praTama', 'vachana' => 'eka'),
						'AtAm' => array('purusha' => 'praTama', 'vachana' => 'dvi'),
						'Ja' => array('purusha' => 'praTama', 'vachana' => 'bahu'),
						'TAs' => array('purusha' => 'maDyama', 'vachana' => 'eka'),
						'ATAm' => array('purusha' => 'maDyama', 'vachana' => 'dvi'),
						'Dvam' => array('purusha' => 'maDyama', 'vachana' => 'bahu'),
						'iw' => array('purusha' => 'uttama', 'vachana' => 'eka'),
						'vahi' => array('purusha' => 'uttama', 'vachana' => 'dvi'),
						'mahiN' => array('purusha' => 'uttama', 'vachana' => 'bahu')
	);
