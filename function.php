...
$juhotyAdi=array("f","ki","kita!","gA","Gf","jana!","tura!","qudAY","Dana!","quDAY","Diza!","Riji!r","pf","pF","pF","Basa!","YiBI","BfMSu!","mAN","viji!r","vizx!","sf","o!hAN","o!hAk","hu","hf","hrI");
...
$vikaraNa=array("ap","yan","nu","a","na","nA","Aya","Ana","u","Ri");
...
$ArdhadhAtuka_pratyayas=array_merge($kitGit_ArdhadhAtuka_pratyayas,$vikaraNa_ArdhadhAtuka_pratyayas,$other_ArdhadhAtuka_pratyayas); // will add others in ArdhadhAtuka prakaraNa
